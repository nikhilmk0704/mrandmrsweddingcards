...
(function($, window, document, undefined){
  ...
  function GeoComplete1(input, options) {
  ...
  $.extend(GeoComplete1.prototype, {
    ...
    markerDragged: function(event){
      this.trigger("geocode:dragged", event.latLng);
	 	...
	 	$("#lat2").val(event.latLng.k);
			$("#lng2").val(event.latLng.D);
   ...
   //	$("#lat").val(place['geometry']['location'].k);
	//		$("#lng").val(place['geometry']['location'].D);
      if (!place || !place.geometry){
        if (this.options.autoselect) {
          ...
          this.find(autoSelection);
		   	...
		   	$("#lat2").val(place['geometry']['location'].k);
			$("#lng2").val(place['geometry']['location'].D);
  ...
  $.fn.geocomplete1 = function(options) {
    ...
    if (typeof options == "string"){
      ...
      var instance = $(this).data(attribute) || $(this).geocomplete1().data(attribute),
      ...
      return this.each(function() {
        ...
        if (!instance) {
          instance = new GeoComplete1( this, options );
