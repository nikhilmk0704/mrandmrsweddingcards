        ...
        <div class="modal-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="name_edit" id="name_edit"
                                       ...
                                       value="<?php echo ucfirst($color['colorName']); ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="color" name="color_edit" id="color_edit"
                                       class="form-control input-inline input-medium" placeholder=""
                                       value="<?php echo $color['colorCode']; ?>"
                                       required>
            ...
            <div class="modal-footer ">
                <button type="button" class="btn blue"
                        onclick="updateColor(<?php echo $color['id']; ?>);">
                    Save changes
                </button>
